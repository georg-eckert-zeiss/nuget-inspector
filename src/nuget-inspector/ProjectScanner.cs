...
internal class ProjectScanner
{
    ...
    /// </summary>
    /// <param name="scan_result"></param>
    public void RemoveInternalProjectDependencies(ScanResult scan_result)
    {
        scan_result.project_package.dependencies = scan_result.project_package.dependencies
            .Where(dep => dep.is_internal_project)
            .ToList();
    }
